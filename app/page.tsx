    ...
    <div className=" bg-[#121212] font-sans">
      ...
      <section id="hero" className="">
        <GridBackgroundDemo className=" relative flex flex-col items-center justify-start pt-24">
          <div className="flex flex-col items-center">
            <h1 className="text-center text-5xl font-semibold leading-tight text-white sm:text-6xl">
            ...
            <div className="mt-10 flex flex-wrap items-center justify-center gap-4 ">
              ...
              <button 
                ...
                className="rounded-full border border-primary bg-transparent hover:cursor-pointer px-6 py-3 font-bold text-white hover:bg-primary/10 shadow-pytch-cta transition-all duration-200 hover:shadow-pytch-cta-hover hover:scale-105 active:scale-95 active:shadow-pytch-cta-active"
              >
                Join as Investor
              </button>
              ...
              <div className="relative max-w-[90%] w-full md:max-w-5xl mt-12 mx-auto rounded-3xl flex flex-col items-center justify-center overflow-hidden">
                ...
                />
                  {/* Subtle dark fade from bottom for dark background */}
                <div className="pointer-events-none absolute inset-x-0 bottom-0 h-1/3 bg-gradient-to-t from-[#121212] via-[#121212]/80 to-transparent"></div>
            </div>
            </div>
          </div>
      ...
      <section id="features" className="flex flex-col items-center justify-center">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl mt-10 font-semibold text-center text-white">Built for the Future of Startup Investment</h2>
          <p className="text-center text-lg mt-4 text-zinc-400 max-w-lg mx-auto">
          ...
          <div className="mt-10 max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-0">
            <div className="bg-zinc-900/50 backdrop-blur-sm relative px-2 py-8  flex flex-col items-center justify-start border-solid border-t-2 border-l-2 border-r-2 border-zinc-800 ">
              ...
              <h3 className="text-xl font-semibold text-center py-3 md:py-4 text-white">Liquidity and Trading</h3>
              <p className="text-center text-base text-zinc-400 text-balance">
              Trading of private startup shares, unlocking liquidity for early investors.
              </p>
            </div>
            <div className="bg-zinc-900/50 backdrop-blur-sm relative px-2 py-8  flex flex-col items-center justify-start border-solid border-t-2 border-r-2 border-zinc-800 ">
              ...
              <h3 className="text-xl font-semibold text-center py-3 md:py-4 text-white">Verified Ecosystem</h3>
              <p className="text-center text-base text-zinc-400 text-balance">
            ...
            <div className="bg-zinc-900/50 backdrop-blur-sm relative px-2 py-8  flex flex-col items-center justify-start border-solid border-t-2 border-r-2 border-zinc-800 ">
              ...
              <h3 className="text-xl font-semibold text-center py-3 md:py-4 text-white">Smart Dashboard</h3>
              <p className="text-center text-base text-zinc-400 text-balance">
            ...
            <div className="bg-zinc-900/50 backdrop-blur-sm relative px-2 py-8  flex flex-col items-center justify-start border-solid border-t-2 border-r-2 border-zinc-800 ">
              ...
              <h3 className="text-xl font-semibold text-center py-3 md:py-4 text-white">AI Matchmaking</h3>
            ...
            <div className="bg-zinc-900/50 backdrop-blur-sm relative px-2 py-8  flex flex-col items-center justify-start border-solid border-t-2 border-r-2 border-zinc-800 ">
              ...
              <h3 className="text-xl font-semibold text-center py-3 md:py-4 text-white">Smart Analytics</h3>
              <p className="text-center text-base text-zinc-400 text-balance">
            ...
            <div className="bg-zinc-900/50 backdrop-blur-sm relative px-2 py-8  flex flex-col items-center justify-start border-solid border-t-2 border-r-2 border-zinc-800 ">
              ...
              <h3 className="text-xl font-semibold text-center py-3 md:py-4 text-white">Secure and Reliable</h3>
              <p className="text-center text-base text-zinc-400 text-balance">
      ...
      {/* Waitlist Banner */}
      <section className="mt-20 w-full bg-[#F7D21B] text-black">
        <div className="mx-auto flex w-full max-w-5xl flex-col items-center px-6 py-16 text-center md:px-8">
          <h2 className="text-3xl font-semibold leading-tight text-black sm:text-4xl md:text-5xl lg:text-6xl">
            Join The Waitlist
          </h2>
          <p className="mt-4 max-w-3xl text-base text-black/80 sm:text-lg md:text-xl">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
            <button
              onClick={() => handleOpenDialog("startup")}
              className="rounded-full bg-black px-7 py-3 font-semibold text-primary shadow-pytch-cta transition-all duration-200 hover:shadow-pytch-cta-hover hover:scale-105 active:scale-95 active:shadow-pytch-cta-active"
            >
              Join as Startup
            </button>
            <button
              onClick={() => handleOpenDialog("investor")}
              className="rounded-full border border-black bg-transparent px-7 py-3 font-semibold text-black shadow-pytch-cta transition-all duration-200 hover:bg-black hover:text-primary hover:shadow-pytch-cta-hover hover:scale-105 active:scale-95 active:shadow-pytch-cta-active"
            >
              Join as Investor
            </button>
          </div>
      ...
      {/* Footer Section */}
      <footer className="mt-0 bg-zinc-950/80 backdrop-blur-sm border-t border-zinc-800">
        <div className="max-w-6xl mx-auto px-6 py-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col items-start">
              ...
              <a 
                href="#features" 
                className="text-primary/80 hover:text-primary transition-colors duration-200 mb-2"
              >
                Features
              </a>
            </div>
            ...
            <div className="flex flex-col items-start md:items-end">
              <h3 className="text-lg text-left font-semibold mb-4 text-primary">Contact Us</h3>
              <div className="flex items-center gap-2 text-primary/80 hover:text-primary transition-colors duration-200">
